# Stage 30 · Document-at-a-time 执行
...
??? note "文件差异：tests/contract/test_collect_then_fetch.py"
    ```diff
...
??? note "文件差异：tests/unit/search/test_daat_scorer.py"
    ```diff
...
??? note "文件差异：tests/unit/search/test_iterators.py"
    ```diff
...
??? note "文件差异：src/minilucene/search/iterators.py"
    ```diff
...
??? note "支撑文件差异（3 个文件）"
    **`pyproject.toml`**
    ...
    index 09e9d1ce9076824ff91644b16c79b5ea03ebeab2..e9dd214949dc127caa20176de232515d184edfa8 100644
    --- a/pyproject.toml
    +++ b/pyproject.toml
    @@ -14,6 +14,7 @@ minilucene = "minilucene.cli:main"
    ...
    **`uv.lock`**
    ...
    index f967c7093e05bcbab0e0c898a5c83fa32f53d63a..0676c9cfc7712ccafc9cd0e7c7281923a844c006 100644
    --- a/uv.lock
    +++ b/uv.lock
    @@ -2,6 +2,110 @@ version = 1
     revision = 3
