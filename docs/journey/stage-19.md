...
??? note "File diff: tests/nrt/test_delete_by_term.py"
    ```diff
    diff --git a/tests/nrt/test_delete_by_term.py b/tests/nrt/test_delete_by_term.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..6687575616f43115daa8b347103ecd47b77ba36f
    --- /dev/null
    +++ b/tests/nrt/test_delete_by_term.py
    @@ -0,0 +1,68 @@
...
??? note "File diff: src/minilucene/index/directory.py"
    ...
    index 5dfe05ef75db082b661a732e8c3877243cca402a..58b7896fd4b30befa163456645075090df8c633d 100644
...
??? note "File diff: src/minilucene/index/memory.py"
    ...
    index e54e6f3d2ea5f43ad17365449b12b570030e7a3d..7e9b119c4d85268e2857f45122a35ac7228eb3ae 100644
    ...
    @@ -54,6 +55,10 @@ class RamIndexBuilder:
    ...
    @@ -105,6 +111,12 @@ class RamIndexBuilder:
...
??? note "File diff: src/minilucene/search/reader.py"
    ...
    index 97cd1d7f6bbf5f8dee41f0c891a0b9564d31e5e7..2f80ce0073fdfabc8e1581bb29133003c20b6eea 100644
...
??? note "File diff: src/minilucene/storage/live_docs.py"
    ```diff
    diff --git a/src/minilucene/storage/live_docs.py b/src/minilucene/storage/live_docs.py
    index 7d520e8da9556aa5514f328cb983359f763154a6..6739b030a8a2a229c17e8efa3e91df2c3b926202 100644
    --- a/src/minilucene/storage/live_docs.py
...
??? note "File diff: src/minilucene/writer.py"
    ...
    index baae188c44b902865368f15986cb4f69e6973aa0..214a9fd68607a3051d3725739b590a3df345cb8f 100644
    --- a/src/minilucene/writer.py
    +++ b/src/minilucene/writer.py
    @@ -8,6 +8,7 @@ from minilucene.errors import WriterAlreadyOpenError
    ...
    @@ -96,24 +131,36 @@ class IndexWriter:
    ...
    @@ -125,12 +172,56 @@ class IndexWriter:
                 )
    ...
    +
         def commit(self) -> Manifest:
             self._ensure_open()
             self.flush()
    @@ -139,15 +230,58 @@ class IndexWriter:
                     generation, self.index.schema.fingerprint
                 )
...
[Complete reference patch / 完整参考补丁](https://github.com/system-in-miniature/mini-lucene/blob/main/journey/stages/19-delete-by-term/stage.patch)
