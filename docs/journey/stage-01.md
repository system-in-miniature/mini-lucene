# Stage 01 · Field and document contract
...
??? note "File diff: tests/contract/test_schema.py"
    ```diff
    diff --git a/tests/contract/test_schema.py b/tests/contract/test_schema.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..94bc6d4fbe513dd5ac41a87a5374434f0e3ba848
    --- /dev/null
    +++ b/tests/contract/test_schema.py
    @@ -0,0 +1,66 @@
    +import pytest
    +
...
??? note "File diff: tests/test_public_surface.py"
    ```diff
    diff --git a/tests/test_public_surface.py b/tests/test_public_surface.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..b5365f66d33290b410c23141fb8dc55adddcf10c
    --- /dev/null
...
??? note "File diff: src/minilucene/document.py"
    ```diff
    diff --git a/src/minilucene/document.py b/src/minilucene/document.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..997ea3775803621fd668225e385da2a4b4a5da08
    --- /dev/null
    +++ b/src/minilucene/document.py
    @@ -0,0 +1,20 @@
...
??? note "File diff: src/minilucene/schema.py"
    ```diff
    diff --git a/src/minilucene/schema.py b/src/minilucene/schema.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..4f581131c5c8993b99296fd1f3c1b52950572aa6
    --- /dev/null
    +++ b/src/minilucene/schema.py
    @@ -0,0 +1,92 @@
...
??? note "Supporting file diffs (3 files)"
    **`pyproject.toml`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..ffdd634f061ce485ef7703c4445fc1c35f833a5e
    --- /dev/null
    +++ b/pyproject.toml
    @@ -0,0 +1,23 @@
    +[build-system]
    ...
    **`src/minilucene/__init__.py`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..721912e6f3b75a9afc6f77eb7af3eb1fc91c4d24
    --- /dev/null
    ...
    **`uv.lock`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..f967c7093e05bcbab0e0c898a5c83fa32f53d63a
    --- /dev/null
    +++ b/uv.lock
    @@ -0,0 +1,108 @@
    +version = 1
...
[Complete reference patch / 完整参考补丁](https://github.com/system-in-miniature/mini-lucene/blob/main/journey/stages/01-schema-contract/stage.patch)
