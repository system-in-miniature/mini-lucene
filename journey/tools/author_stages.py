#!/usr/bin/env python3
"""Materialize the reviewed bilingual MiniLucene Stage lessons and layouts."""
...
CHAPTER_SLUGS = {
    ...
    4: "04-codec",
    5: "05-segments-nrt",
    6: "06-deletes-updates",
    7: "07-commit-atomicity",
    8: "08-scoring",
    9: "09-query-language",
    10: "10-merge-and-beyond",
    11: "11-daat",
}
...
[第 {chapter} 章](https://github.com/system-in-miniature/mini-lucene/blob/main/docs/zh/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
    return f"""### Goal
...
[Chapter {chapter}](https://github.com/system-in-miniature/mini-lucene/blob/main/docs/tutorial/{CHAPTER_SLUGS[chapter]}.md)"""
...
def main() -> int:
    ...
    print("wrote 30 bilingual MiniLucene goals and layouts")
    return 0
