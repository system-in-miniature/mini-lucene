...
Use this mode when you want Codex to guide one MiniLucene Stage interactively in
the terminal.

## 1. Open Codex in MiniLucene
...
Replace `03` with any Stage from `01` through `30`. Codex prepares the correct
